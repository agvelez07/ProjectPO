    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @endif
                <tr>
                    <form method="post" action="{{ url('Update-PO/0')}}" class="POForm">
                        @csrf
                ...
                <div>
                    <div style="display: inline-flex; margin-bottom: 20px;">
                        <a class="addButtons" data-bs-toggle="modal" data-bs-target="#Create">
                            <img src="{{ asset('imgs/add.svg') }}" alt="+" class="plus"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    <form method="post" action="{{ url('Save-Order') }}" enctype="multipart/form-data">                                        @csrf
                                        ...
                                        <label for="invoice_path">Carregar Fatura</label>
                                        <br>
                                        <input type="file" name="invoice_path" id="invoice_path">
                                        <div>
