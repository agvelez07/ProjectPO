...
Route::post('/POs/Save-PO', [POController::class, 'savePO'])->name('po.save');

Route::get('/POs/Edit/{id}', [POController::class, 'Edit'])->name('po.edit');

Route::post('/POs/Update-PO/{id}', [POController::class, 'updatePO'])->name('po.update');

Route::get('/POs/Details/{id}', [POController::class, 'Details'])->name('po.details');
