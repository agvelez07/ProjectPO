                            ...
                            @foreach ($data as $po)
                                <tr>
                                    ...
                                    @foreach ($suppliersData as $supplier)
                                        ...
                                        @endif
                                    @endforeach
                                    <td>{{ date('d/m/Y', strtotime($po->dateInit)) }}</td>
                                    <td>{{ date('d/m/Y', strtotime($po->dateEnd)) }}</td>

                                    @if ($po->costType == 0)
                                        <td>Pagamento Único</td>
                                    @elseif ($po->costType == 1)
                                        <td>Mensal</td>
                                    @endif
                                    ...
                                    <td style="padding-top: 0 5px 0 0 !important;">
                                        ...
                                        <a class="btn btn-details" data-bs-toggle="modal"
                                            data-bs-target="#Details/{{$po->id}}">
                                            <img src="{{ asset('imgs/details.svg') }}" alt="Details" class="delete"
                                            ></a>
                                    </td>
                                        ...
                                        <form method="post" action="{{ url('Save-PO') }}">
                                            ...
                                            <div class="md-3">
                                                ...
                                                <input type="text" class="form-control" name="num"
                                                    placeholder="Número de Ordem" value="{{ old('num') }}">
                                                @error('num')
                                                    <div class="alert alert-danger" role="alert">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="md-3">
                                                ...
                                                <input type="date" class="form-control" name="dateInit"
                                                    value="2023-12-01" min="2023-12-01" value="{{ old('dateInit') }}">
                                                @error('dateInit')
                                                    <div class="alert alert-danger" role="alert">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="md-3">
                                                ...
                                                <input type="date" class="form-control" name="dateEnd"
                                                    value="2023-12-01" min="2023-12-01" value="{{ old('dateEnd') }}">
                                                @error('dateEnd')
                                                    <div class="alert alert-danger" role="alert">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="md-3">
                                                ...
                                                <input type="text" class="form-control" name="totalCost"
                                                    placeholder="000,00€" value="{{ old('totalCost') }}">
                                                @error('totalCost')
                                                    <div class="alert alert-danger" role="alert">
                                                        {{ $message }}
                                                    </div>
